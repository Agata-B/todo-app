...
class ProjectServiceTest {
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when configured to allow 1 group and no groups and no projects for a given id")
    ...
    void createGroup_configurationOk_existingProject_createAndSaveGroup() {
        ...
        //then
        assertThat(result.getDescription()).isEqualTo("vacation");
