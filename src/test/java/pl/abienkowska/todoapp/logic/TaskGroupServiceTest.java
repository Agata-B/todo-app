...
class TaskGroupServiceTest {
    ...
    void toggleGroup_undoneTasks_throwsIllegalStateException() {
        //given
        TaskRepository mockTaskRepository = tasksRepositoryReturning(true);
        //system under test
    ...
    void toggleGroup_wrongId_throwsIllegalArgumentException() {
        //given
        TaskRepository mockTaskRepository = tasksRepositoryReturning(false);
        //and
    ...
    private TaskRepository tasksRepositoryReturning(final boolean result) {
